...
mod tests {
    ...
    fn cnblock() {
        ...
        let (cn_block, position) = mdf3::CNBLOCK::read(&cn_data, true);
        ...
        assert!(utils::eq(
            &cn_block.short_name,
            &[
				0x74, 0x69, 0x6D, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ]
        ));
		...
		assert_eq!(cn_block.signal_min, utils::read_f64(&[0x04, 0x19, 0x60, 0x9C, 0xAE, 0xDD, 0xBC, 0x3F,], true, &mut (0 as usize)));
		assert_eq!(cn_block.signal_max, utils::read_f64(&[0x52, 0xE8, 0x62, 0xFA, 0x56, 0xD3, 0x28, 0x40,], true, &mut (0 as usize)));
